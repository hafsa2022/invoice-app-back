...
<body>
    <div class="container">
            ...
            <div class="row mb-3 g-2">
                    <div class="col-md-6 left-content"><h1>{{ $setting->company_name }}</h1></div>
            ...
            <div class="row mb-3 mt-3">
                <div class="col-md-6 right-content " >
                    ...
                    <div class="row col">
                        <p><span class="float-start">TVA 20% de {{$invoice->amount}}</span> <span class="float-end"> {{ number_format(($invoice->amount * 0.02), 2, ',', '.')}}</span></p>
                    </div>
                    <div class="row col mb-3">
                        <p><span class="float-start">Montant Total EUR</span> <span class="float-end"> {{$invoice->amount + ($invoice->amount * 0.02)}} </span></p>
                    </div>
                    <br>
                    <hr>
                   <div class="row col">
                   ...
                   <div class="row col">
                       <strong><p> <span class="float-start">Montant à payer (EUR)</span> <span class="float-end"> {{number_format((($invoice->amount + ($invoice->amount * 0.02)) - $invoice->advance), 2, ',', '.')}}</span></p></strong>
                   </div>
